...
export function CTACard({
	...
	const variantClassName = isProject
		...
		: isWide
			? 'infrastructure-cta--wide'
			: 'infrastructure-cta--default'
	const buttonClassName = `flex w-full shrink-0 items-center justify-center bg-[#0051FF] px-6 text-center text-white transition-transform hover:scale-[1.01] hover:bg-[#0050f2] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#0B5CFF] active:scale-[0.99] rounded-[13px] ${
		isProject
