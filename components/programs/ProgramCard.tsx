    ...
    <article className="program-card relative overflow-hidden rounded-[34px] bg-[#FFFF19] text-black shadow-[0_18px_60px_rgba(0,0,0,0.2)] md:rounded-[35px] xl:h-[932px] xl:w-[452px]">
      ...
      <div className="relative z-10 bg-[#1D1D1D] md:rounded-[35px] xl:absolute xl:left-0 xl:top-0 xl:h-[692px] xl:w-full">
        ...
        <div className="px-8 pb-10 pt-10 md:px-10 md:pt-10 xl:p-0">
          <h3 className="max-w-[330px] text-[31px] font-semibold leading-[1.08] tracking-normal text-[#FFFF19] md:text-[33px] md:leading-[40px] xl:absolute xl:left-10 xl:top-[490px] xl:w-[372px]">
            {card.title}
          </h3>
          <p className="mt-8 max-w-[370px] text-[21px] font-medium leading-[1.18] tracking-normal text-[#C4C4C4] md:text-[22px] md:leading-[26px] xl:absolute xl:left-10 xl:top-[595px] xl:mt-0 xl:w-[372px]">
            {card.description}
          </p>
        </div>
      </div>
      ...
      <div className="relative z-20 flex flex-col justify-between px-8 pb-10 pt-9 md:px-10 xl:absolute xl:left-10 xl:top-[732px] xl:h-[161px] xl:w-[372px] xl:p-0">
        <div className="space-y-[13px] text-[20px] font-medium leading-[26px] tracking-normal text-[#1D1D1D] md:text-[22px]">
          <p>{card.audience}</p>
          <p>{card.age}</p>
        </div>
